      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative mx-auto max-h-[92vh] w-full max-w-[520px] overflow-y-auto rounded-t-3xl bg-tg-bg p-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] shadow-[0_-8px_40px_rgba(0,0,0,0.18)]"
          >
