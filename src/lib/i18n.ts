...
const DICT = {
  ...
  /* Достижения (v5.90): каталог в lib/achievements.ts */
  'ach.row': ['Достижения', 'Achievements'],
  'ach.rowHint': ['награды за активность', 'rewards for activity'],
  'ach.title': ['Достижения', 'Achievements'],
  'ach.guestTitle': ['Войдите по Telegram', 'Sign in with Telegram'],
  'ach.guestHint': [
    'Достижения и награды за активность',
    'Achievements and rewards for activity',
  ],
  'ach.summaryOf': ['открыто ступеней', 'steps unlocked'],
  'ach.groupActivity': ['Активность', 'Activity'],
  'ach.groupSocial': ['Социальное', 'Social'],
  'ach.groupCollection': ['Коллекции', 'Collections'],
  'ach.groupProgress': ['Прогресс', 'Progress'],
  'ach.tierBronze': ['Бронза', 'Bronze'],
  'ach.tierSilver': ['Серебро', 'Silver'],
  'ach.tierGold': ['Золото', 'Gold'],
  'ach.toBronze': ['до Бронзы', 'to Bronze'],
  'ach.toSilver': ['до Серебра', 'to Silver'],
  'ach.toGold': ['до Золота', 'to Gold'],
  'ach.progressTo': ['до', 'to'],
  'ach.of': ['из', 'of'],
  'ach.done': ['Всё получено', 'All unlocked'],
  'ach.unlockedAt': ['получено', 'unlocked'],
  'ach.empty': ['Откройте первую ступень — награды уже ждут', 'Unlock the first step — rewards await'],
  'ach.reload': ['Повторить', 'Retry'],
  'ach.ariaSteps': ['Ступени достижения', 'Achievement steps'],
