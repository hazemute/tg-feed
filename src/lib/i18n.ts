...
const DICT = {
  ...
  'post.shareSheetSub': ['Отправьте пост друзьям или опубликуйте у себя', 'Send the post to friends or publish it'],
  ...
  'level.subtitle': ['Опыт, награды и история XP', 'XP, rewards and history'],
  ...
  'level.bugHint': ['начисляет админ вручную — по реальному багу', 'granted manually by admin for real bugs'],
  ...
  'level.empty': ['Пока пусто. Напишите толковый комментарий — +2 XP', 'Empty for now. Write a good comment — +2 XP'],
  'level.guestTitle': ['Уровни — для авторизованных', 'Levels — for signed-in users'],
  'level.guestHint': ['Войдите по Telegram: XP за активность, свайпы за уровни', 'Sign in with Telegram: XP for activity, swipes for levels'],
  ...
  'lb.subtitle': ['Топы игроков · рубли не участвуют', 'Player tops · no money ranked'],
  ...
  'lb.guestHint': ['Уровни, свайпы и активность — всё считается после входа', 'Levels, swipes and activity count after sign-in'],
  'lb.updated': ['Обновляется каждую минуту', 'Refreshed every minute'],
  'lb.refresh': ['Обновить', 'Refresh'],
  'lb.noRubles': ['Финансы в рейтингах не участвуют', 'Money is not ranked here'],
  'lb.empty': ['Пока пусто — станьте первым', 'Empty for now — be the first'],
  ...
  'lb.openFromLevelHint': ['соревнуйтесь XP-активностью', 'compete with XP activity'],
  ...
  'lb.prizeLiveWeek': ['Топ недели — живой счёт', 'This week — live'],
  'lb.prizeLastWeek': ['Итоги прошлой недели', 'Last week winners'],
  'lb.prizeLastMonth': ['Итоги прошлого месяца', 'Last month winners'],
  ...
  'feed.postHiddenHint': ['Похожие посты будут показываться реже — канал остаётся в ленте', 'Similar posts will be shown less — the channel stays in your feed'],
  'feed.reportTitle': ['Пожаловаться на пост', 'Report post'],
  'feed.reportSent': ['Жалоба отправлена — спасибо, мы проверим', 'Report sent — thank you, we will review it'],
