  ...
  try {
    ...
    const rows = await db.$queryRawUnsafe<Row[]>(`
      ...
      WHERE c.table_schema = 'public' AND (
        ...
        (c.table_name = 'UserSource' OR c.table_name = 'Quest' OR c.table_name = 'QuestCompletion' OR c.table_name = 'ScheduledPost' OR c.table_name = 'PromoCode' OR c.table_name = 'PromoRedemption' OR c.table_name = 'PostHide' OR c.table_name = 'PostReport' OR c.table_name = 'CommentReport' OR c.table_name = 'DailyCheckin' OR c.table_name = 'QuestVerifyLog' OR c.table_name = 'BotChat' OR c.table_name = 'BotUser' OR c.table_name = 'AiChatSession' OR c.table_name = 'XpLog' OR c.table_name = 'Sponsor' OR c.table_name = 'AdSlot' OR c.table_name = 'Blacklist') OR
