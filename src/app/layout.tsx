...
(function(){
  ...
  /* v5.89 ПОСЛЕДНИЙ РУБЕЖ: если через 30с шторка всё ещё висит — React так и
     не поднялся, а кнопку «Перезагрузить» юзер не нажал. Тихо пробуем
     самолечение: guardReload сам ограничен частотой 1/45с (без циклов).
     Нормальная загрузка сюда не доходит: шторка скрыта на монтировании. */
  T.push(setTimeout(guardReload,30000));
})();
}catch(e){}`
