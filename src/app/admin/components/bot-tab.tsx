            ...
            <div className="min-w-56">
              ...
              <p className="mt-1 max-w-2xl text-xs leading-relaxed text-slate-500">
                {data.dmNotifyOff
                  ...
                  : 'Лайки/ответы/награды дублируются в личку. Глобальный антиспам (v6.4.0): 1 ЛС на комментарий в 6ч, ≤3 лайк-ЛС за сутки, 1 ЛС на пост×тип в 3ч, ≤6 ЛС за сутки, кап 2/мин — единый лимит на все инстансы.'}
              </p>
            </div>
            <button
              type="button"
